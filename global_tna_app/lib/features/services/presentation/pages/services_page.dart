...
class ServicesPage extends StatelessWidget {
      ...
      builder: (dialogContext) {
        return _AddToCartDialog(
          ...
          onSubmit: (slotId, bookingDate, quantity) {
            cartBloc.add(AddCartItemEvent(service.id, slotId, bookingDate, quantity));
          },
        );
      },
    );
  ...
  Widget build(BuildContext context) {
    return MultiBlocProvider(
      providers: [
        BlocProvider(
          create: (_) => sl<ServicesBloc>()..add(const FetchServicesEvent()),
        ),
              ...
              const Padding(
                ...
                child: Row(
                  children: [
                    ...
                    SizedBox(width: 10),
                    Expanded(child: Text('Loading available slots...')),
                  ],
                ),
              )
